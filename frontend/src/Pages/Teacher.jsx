...
function Teacher() {
  ...
  const filteredTeacher = filterSubject
    ? teacher.filter((t) => t.subject.toLowerCase() === filterSubject.toLowerCase())
    : teacher;
  ...
  return (
    <Layout>
      ...
      <div className="filter-section">
        <label htmlFor="subjectFilter">Filter by Course/Subject: </label>
        <select
          id="subjectFilter"
          value={filterSubject}
        ...
        <button className="btn" onClick={() => setFilterSubject("")}>Clear Filter</button>
      </div>
